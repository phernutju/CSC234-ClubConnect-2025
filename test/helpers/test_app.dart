...
Widget makeTestApp({
  ...
  final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/notification', builder: (_, __) => _stub('notification')),
      ...
      GoRoute(
          path: '/edit-community', builder: (_, __) => _stub('edit-community')),
      GoRoute(path: '/events', builder: (_, __) => _stub('events')),
      GoRoute(path: '/create-event', builder: (_, __) => _stub('create-event')),
      GoRoute(path: '/edit-event', builder: (_, __) => _stub('edit-event')),
      GoRoute(path: '/event-detail', builder: (_, __) => _stub('event-detail')),
      GoRoute(path: '/event-chat', builder: (_, __) => _stub('event-chat')),
      GoRoute(path: '/create-bill', builder: (_, __) => _stub('create-bill')),
      GoRoute(path: '/bill-summary', builder: (_, __) => _stub('bill-summary')),
      GoRoute(path: '/bill-payment', builder: (_, __) => _stub('bill-payment')),
      GoRoute(
          path: '/payment-success',
          builder: (_, __) => _stub('payment-success')),
      GoRoute(path: '/banned', builder: (_, __) => _stub('banned')),
      GoRoute(
          path: '/admin-reports', builder: (_, __) => _stub('admin-reports')),
      GoRoute(
          path: '/admin-report-detail',
          builder: (_, __) => _stub('admin-report-detail')),
      GoRoute(
          path: '/global-events', builder: (_, __) => _stub('global-events')),
      GoRoute(
          path: '/other-profile', builder: (_, __) => _stub('other-profile')),
    ],
  );
...
Widget _stub(String name) => Scaffold(body: Center(child: Text('stub:$name')));
