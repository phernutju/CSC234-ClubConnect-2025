...
class AppColors {
  ...
  static const Color dialogHighlight =
      Color(0x26FF6B4A); // #FF6B4A @ ~15% opacity
...
class AppStrings {
  ...
  static const String otpSubtitle = "We've sent a text message to your phone!\n"
  ...
  static const String categorySubtitle =
      "Pick your interests. We'll surface live rooms in these.";
  ...
  static const String chatImageMessage =
      '[Image]'; // fallback text for image-only messages
  static const String warningText =
      'Message failed to send. This content goes against our community standards. Repeated offenses will result in a ban. ';
  static const String warningReviewRules = 'Review rules';
  static const String banText =
      'You have been restricted from using chat due to your behavior. chat again on ';
  ...
  static const String communityStandardsAgreementPrefix =
  ...
  static const String communityStandardsRule4 = 'No threats or violent content';
